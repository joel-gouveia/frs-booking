...
/* ========== Previously from com.dantsu.escposprinter =========== */
import com.thermalprinter.methods.EscPosPrinter;
import com.thermalprinter.methods.connection.DeviceConnection;
import com.thermalprinter.methods.connection.bluetooth.BluetoothPrintersConnections;
import com.thermalprinter.methods.connection.tcp.TcpConnection;
...
import com.thermalprinter.methods.exceptions.EscPosParserException;
import com.thermalprinter.methods.textparser.PrinterTextParserImg;
/* ========== Previously from com.dantsu.escposprinter =========== */
...
/* ========== Previously from com.dantsu.escposprinter =========== */
import com.thermalprinter.methods.connection.bluetooth.BluetoothConnection;
/* ========== Previously from com.dantsu.escposprinter =========== */
...
public class ThermalPrinterModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void printTcp(String ipAddress, double port, double timeout, String payload, boolean autoCut, boolean openCashbox, double mmFeedPaper, double printerDpi, double printerWidthMM, double printerNbrCharactersPerLine, Promise promise) {
//
//        05-05-2021
